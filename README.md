...
Signal K tank data on Venus OS devices like the Victron CCGX.
This may be useful because Venus OS cannot correctly process tank
data that derives from multi-channel tank sensor devices like the
